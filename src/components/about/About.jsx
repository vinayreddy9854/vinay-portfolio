      ...
      <div className="about__container grid">
        ...
        <div className="about__data">
          <p className="about__description">
            ...
            <br /><br />
            I specialize in React, Flutter, Firebase, Python, and machine learning. I enjoy solving real-world problems through code and turning ideas into useful digital products.
          </p>
